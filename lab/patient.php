...
<head>
    ...
    <link rel="stylesheet" href="static/css/examinations_patient_review.css">
    <script src="static/js/examinations_patient_review.js"></script>
</head>
<body>
...
$sql = "SELECT * FROM research_parents where patient_id='$userid'";
$stmt = $connect->prepare($sql);
$stmt->execute();
